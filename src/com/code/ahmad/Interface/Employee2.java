...
public class Employee2 implements Manager {
	...
	// constructor
	public Employee2(int id, String name, String email) {
		this.id = id;
		this.name = name;
		this.email = email;
	}
	...
	public void calculatePay(int numberOfHours) {
		...
		System.out.println("I am employee 2 my name is "+name+
	...
	public String toString() {
		return "Employee2 [id=" + id + ", name=" + name + ", email=" + email + ", numberOfHours=" + numberOfHours + "]";
	}
